...
parser.add_argument('--labels_path', type=str, default='/home/aistudio/ECO-pp/data/dataset_labels/', help="root directory holding the 20bn csv files: labels, train & validation")
parser.add_argument('--out_list_path', type=str, default='/home/aistudio/ECO-pp/data/')
